...
const Menu = () => {
  ...
  return (
    <div className="cursor-pointer">
      ...
      {open && (<div className="bg-red-500 text-white absolute left-0 top-24 w-full h-[calc(100vh-6rem)] gap-8 flex flex-col items-center justify-center text-3xl z-10">
        {links.map((item)=>(
